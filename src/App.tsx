...
const diary: DiaryItem[] = [
  ...
  { image: 'portella-1.png', title: { it: 'Portella 1', en: 'Portella 1' }, text: { it: 'Portella 1', en: 'Portella 1' } },
  ...
  return <article className="pub-card">
    {p.cover && <div className="pub-cover-wrap">
      <button type="button" className="pub-cover-btn" aria-label={lang === 'it' ? 'Sfoglia' : 'Browse'} onClick={() => linksRef.current?.openMain()}>
        <img className="pub-cover" src={`./images/${p.cover}`} alt={t(p.title)}/>
