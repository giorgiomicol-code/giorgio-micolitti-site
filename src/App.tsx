...
function App() {
  ...
  return <div className="site-shell">
    ...
    <main id="top">
      ...
      <section id="teaching" className="light"><div className="wrap teaching-grid"><p className="kicker">10 · {lang === 'it' ? 'DOCENZE' : 'TEACHING'}</p><h2>Sapienza<br/>{lang === 'it' ? 'Università di Roma' : 'University of Rome'}</h2><p className="lead">{lang === 'it' ? 'Docente di Tecnica dei Cantieri Infrastrutturali presso il Master Sapienza in Ingegneria delle Infrastrutture e dei Sistemi Ferroviari (IIS), edizioni 2020, 2021 e 2022.' : 'Lecturer in Infrastructure Construction Site Techniques within Sapienza University Master in Infrastructure and Railway Systems Engineering (IIS), editions 2020, 2021 and 2022.'}</p><div className="bridge-videos"><div className="video-embed"><VideoPlayer id="VoLegEc26A8" title={lang === 'it' ? 'Lezione Master IIS' : 'Master IIS Lecture'}/><p className="video-caption">{lang === 'it' ? 'Lezione Master IIS del 10.06.2022 — Master Università Sapienza di Roma, Ingegneria delle Infrastrutture e dei Sistemi Ferroviari, ed. 2022.' : 'Master IIS lecture, 10 June 2022 — Sapienza University of Rome Master in Infrastructure and Railway Systems Engineering, 2022 edition.'}</p></div><div className="video-embed"><VideoPlayer id="5Zk6x1oAifc" title={lang === 'it' ? 'Docenza di Tecnica dei Cantieri Infrastrutturali al Master IIS 2021' : 'Lecture on Infrastructure Construction Site Techniques at the IIS Master, 2021'}/><p className="video-caption">{lang === 'it' ? 'Docenza di Tecnica dei Cantieri Infrastrutturali al Master IIS 2021.' : 'Lecture on Infrastructure Construction Site Techniques at the IIS Master, 2021 edition.'}</p></div></div></div></section>
