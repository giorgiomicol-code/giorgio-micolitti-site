...
const experience: ExperienceItem[] = [
  {years:'Nov 2023 — Presente',role:{it:'Responsabile Ingegneria Collegamenti Ferroviari',en:'Head of Railway Connections Engineering'},org:'Stretto di Messina S.p.A. · Roma',text:{it:'Guida la Struttura Organizzativa “Ingegneria Collegamenti Ferroviari” di Stretto di Messina S.p.A.',en:'Leads the Railway Connections Engineering organisational unit at Stretto di Messina S.p.A.'}},
  {years:'Dic 2017 — Set 2023',role:{it:'Responsabile Ingegneria Civile, Armamento, Patrimonio e Autorizzazioni, Ponti e Verifiche',en:'Head of Civil Engineering, Trackwork, Property & Authorisations, Bridges & Inspections'},org:'RFI S.p.A. · Direzione Operativa Infrastrutture Roma',text:{it:'Guida la Struttura di Ingegneria Civile con circa 100 risorse, realizzando circa 1 miliardo di euro di investimenti; prima parte dell’Anello Ferroviario di Roma, adeguamento D4 del Nodo di Roma con 38 nuovi ponti, certificazione PC80 TEN-T e sicurezza in 16 gallerie nell’ambito di oltre 20 interventi complessivi.',en:'Led the Civil Engineering unit with approximately 100 people, delivering around €1 billion of investment; the first part of the Rome Railway Ring, D4 upgrading of the Rome node with 38 new bridges, PC80 TEN-T certification, and safety works in 16 tunnels within more than 20 tunnel interventions.'}},
  {years:'Mar 2016 — Nov 2017',role:{it:'Responsabile Opere Civili, Fabbricati e Impianti Speciali',en:'Head of Civil Works, Buildings and Special Systems'},org:'RFI S.p.A. · Direzione Territoriale Produzione Roma',text:{it:'Coordina progettazione e lavori della nuova linea Vigna Clara–Valle Aurelia; upgrade TEN-T; stazioni, armamento e pensiline; piano annuale lavori, uffici di direzione lavori e strumenti contrattuali.',en:'Coordinated design and works for the Vigna Clara–Valle Aurelia line, TEN-T upgrades, stations, trackwork and canopies, annual work plans, site supervision offices and contractual tools.'}},
  {years:'Mag 2014 — Feb 2016',role:{it:'Responsabile U.O. Team Sviluppo Locale Opere Civili',en:'Head of Local Development Civil Works Unit'},org:'RFI S.p.A. · Direzione Territoriale Produzione Roma',text:{it:'Guida lavori di armamento nei PRG di Roma Tiburtina, Casilina, Scalo San Lorenzo e Campo Leone; raccordi ferroviari; 56 km di barriere antirumore AV Roma–Napoli; controllo opere d’arte, rischio in sotterraneo e vulnerabilità sismica.',en:'Led trackwork in major Rome station layouts and industrial sidings; redesigned 56 km of noise barriers on the Rome–Naples high-speed line; led structural asset control, underground risk and seismic vulnerability analyses.'}},
  {years:'Mag 2011 — Apr 2014',role:{it:'Assistente Project Manager e Referente Task Force Sicurezza nelle Gallerie',en:'Assistant Project Manager and Tunnel Safety Task Force Representative'},org:'RFI S.p.A. · Direzione Territoriale Produzione Roma',text:{it:'Dirige lavori civili e tecnologici; coordina sicurezza CSP/CSE per interventi fino a 15 milioni di euro; gestisce stakeholder e conduce analisi di rischio e vulnerabilità sismica.',en:'Directed civil and technological works, coordinated CSP/CSE safety for projects up to €15 million, managed stakeholders and carried out risk and seismic vulnerability analyses.'}},
  {years:'Mag 2009 — Apr 2011',role:{it:'Referente Pianificazione Industriale e Monitoraggio KPI – Business Immobiliare e Trasporto',en:'Industrial Planning & KPI Monitoring – Real Estate and Transport Business'},org:'Ferrovie dello Stato Italiane S.p.A. · Direzione Centrale Strategie e Pianificazione',text:{it:'Pianificazione industriale Real Estate, Business Plan e operazioni straordinarie, mercati europeo e nazionale, KPI di Gruppo e gruppi UIC Financial Indicators / Statistics.',en:'Real Estate industrial planning, business plans and extraordinary transactions, European and national markets, Group KPIs, and UIC Financial Indicators / Statistics working groups.'}},
  {years:'Nov 2006 — Apr 2009',role:{it:'Ingegnere di Progetto – Opere Civili, Strutture in Sotterraneo e Sicurezza',en:'Project Engineer – Civil Works, Underground Structures and Safety'},org:'RFI S.p.A. · Direzione Tecnica, Ingegneria Civile',text:{it:'Rappresenta RFI presso AEIF, CEN, UIC e FIT; partecipa al coordinamento BBT e Torino–Lione; svolge verifiche di appaltabilità per progetti superiori a 20 milioni di euro e sperimentazioni di aerodinamica AV in galleria.',en:'Represented RFI at AEIF, CEN, UIC and FIT; took part in BBT and Turin–Lyon coordination; reviewed tenderability of projects above €20 million and conducted high-speed tunnel aerodynamics testing.'}},
  {years:'Apr 2002 — Ott 2006',role:{it:'Ingegnere di Progetto – Progettazione e Pianificazione Infrastrutture',en:'Project Engineer – Infrastructure Design and Planning'},org:'RFI S.p.A. · Direzione Investimenti',text:{it:'Introduce procedure per diagnosi e manutenzione delle strutture in sotterraneo, modelli prestazionali di rischio, progetti di innovazione tecnologica e dossier economico-finanziari per il Comitato Investimenti.',en:'Introduced procedures for diagnosis and maintenance of underground structures, performance-based risk models, technology innovation projects and economic-financial investment dossiers.'}},
  {years:'Apr 2001 — Apr 2002',role:{it:'Ingegnere di Progetto',en:'Project Engineer'},org:'DMS Engineering S.r.l.',text:{it:'Responsabile della progettazione geotecnica e strutturale di opere stradali, ferroviarie e civili, in superficie e in sotterraneo.',en:'Responsible for geotechnical and structural design of road, railway and civil works, both surface and underground.'}},
  {years:'Lug 2000 — Apr 2001',role:{it:'Ingegnere – Area Tecnico-Patrimoniale',en:'Engineer – Technical Property Area'},org:'Azienda U.S.L. Latina',text:{it:'Cura le valutazioni di sicurezza statica degli asset immobiliari dell’Azienda.',en:'Carried out structural safety assessments of the organisation’s real-estate assets.'}},
]
...
const expertise: Copy[] = [
  ...
  {it:'Capital budgeting e valutazioni economico-finanziarie degli investimenti',en:'Capital budgeting and economic-financial investment appraisal'},
  ...
  {it:'Leadership di team eterogenei, fino a circa 100 persone in 5 dipartimenti',en:'Leadership of heterogeneous teams, up to approximately 100 people across 5 departments'},
]
...
const diary: DiaryItem[] = [
  {image:'stretto.webp',title:{it:'Collegamenti ferroviari del Ponte sullo Stretto',en:'Railway connections to the Strait of Messina Bridge'},text:{it:'Focus professionale attuale dedicato alle opere ferroviarie connesse al sistema infrastrutturale dello Stretto.',en:'Current professional focus on the railway works connected with the Strait infrastructure system.'}},
  {image:'civil-works.webp',title:{it:'Ponti, rinnovi e sostituzioni sulla rete ferroviaria',en:'Railway bridges, renewals and replacements'},text:{it:'Interventi su opere civili ferroviarie realizzati in contesti operativi complessi e con continuità dell’esercizio.',en:'Civil railway works delivered in complex operational contexts while maintaining railway service continuity.'}},
  {image:'interoperability.webp',title:{it:'Adeguamento infrastrutturale e interoperabilità ferroviaria europea',en:'Infrastructure upgrading and European railway interoperability'},text:{it:'Adeguamenti della rete, corridoi TEN-T, TSI e standardizzazione tecnica europea.',en:'Network upgrading, TEN-T corridors, TSIs and European technical standardisation.'}},
  {image:'underground.webp',title:{it:'Gallerie: stabilità, sicurezza e fire engineering',en:'Tunnels: stability, safety and fire engineering'},text:{it:'Geotecnica, sicurezza in esercizio, aerodinamica, normativa europea e progettazione antincendio.',en:'Geotechnics, operational safety, aerodynamics, European regulation and fire-safe design.'}},
]
...
function App() {
  ...
  return <div className="site-shell">
    <header className="site-header">
      ...
      <nav>
        <a href="#profile">{lang==='it'?'Profilo':'Profile'}</a><a href="#rfi">25 anni RFI</a><a href="#expertise">{lang==='it'?'Competenze':'Expertise'}</a><a href="#areas">{lang==='it'?'Aree':'Areas'}</a><a href="#results">{lang==='it'?'Risultati':'Results'}</a><a href="#bridge">Ponte</a><a href="#diary">Project diary</a><a href="#august-2022">Agosto 2022</a><a href="#teaching">{lang==='it'?'Docenza':'Teaching'}</a>
    ...
    <main id="top">
      <section className="hero dark"><div className="wrap"><p className="kicker">CIVIL ENGINEERING · RAILWAY INFRASTRUCTURE</p><h1>Civil Engineering Works,<br/>Infrastructure Constructions,<br/>Tunnels &amp; Safety</h1><p className="hero-sub">Sustainability challenges in a constantly evolving framework</p><p className="hero-name">Giorgio Micolitti</p></div></section>
      ...
      <section id="profile" className="light">
        ...
        <div className="wrap profile-grid"><div className="profile-copy">{profileParagraphs.map((p,i)=><p key={i}>{t(p)}</p>)}</div><aside className="profile-aside"><h3>{lang==='it'?'Esperienza professionale':'Professional experience'}</h3>{experience.map((e,i)=><article className="experience-item" key={i}><span>{e.years}</span><h4>{t(e.role)}</h4><strong>{e.org}</strong><p>{t(e.text)}</p></article>)}<div className="mini-section"><h3>{lang==='it'?'Collaudi e Certificazioni Tecniche':'Testing and Technical Certifications'}</h3><p>{lang==='it'?'Collaudatore Statico e Direttore CTA per numerosi interventi infrastrutturali RFI realizzati tra il 2014 e il 2021, tra cui travate metalliche e ponti, sottopassi, rampe, scale e marciapiedi, pensiline, opere di accessibilità, rinnovo deviatoi e riqualificazione stazioni Easy/Smart Station e Wi‑Fi Station.':'Structural Tester and CTA Director for numerous RFI infrastructure works delivered between 2014 and 2021, including steel spans and bridges, underpasses, ramps, stairs and platforms, canopies, accessibility works, turnout renewals and Easy/Smart Station and Wi‑Fi Station upgrades.'}</p></div><div className="mini-section"><h3>{lang==='it'?'Lingue':'Languages'}</h3><p>{lang==='it'?'Italiano — madrelingua · Inglese — ottimo scritto e parlato · Francese — buono':'Italian — native · English — excellent written and spoken · French — good'}</p></div></aside></div>
      </section>

      <section id="rfi" className="editorial dark"><div className="wrap editorial-grid"><div><p className="kicker">02 · 25 ANNI DI RFI</p><h2>{lang==='it'?'Un’esperienza progressivamente estesa.':'An experience progressively broadened over time.'}</h2></div><div><p className="lead">{lang==='it'?'Dalla pianificazione infrastrutturale e dagli standard tecnici e normativi, alla strategia e valutazione degli investimenti, fino alla gestione operativa, manutenzione e realizzazione delle opere.':'From infrastructure planning and technical standards to strategy and investment appraisal, and then to operational management, maintenance and delivery of works.'}</p><p>{lang==='it'?'Dal 2002 il percorso in RFI e nel Gruppo FS ha attraversato Direzione Investimenti, Direzione Tecnica, Direzione Centrale Strategie e Pianificazione e Direzione Operativa Territoriale di Roma, fino all’attuale responsabilità in Stretto di Messina S.p.A.':'Since 2002, the career within RFI and the FS Group has spanned Investment, Technical, Central Strategy & Planning and Rome Territorial Operations directorates, leading to the current responsibility at Stretto di Messina S.p.A.'}</p></div></div></section>

      <section id="expertise" className="light"><div className="wrap section-head"><p className="kicker">03 · {lang==='it'?'COMPETENZE':'EXPERTISE'}</p><h2>{lang==='it'?'Competenze tecniche e manageriali':'Technical and management capabilities'}</h2></div><div className="wrap two-col-list">{expertise.map((x,i)=><div key={i}><span>{String(i+1).padStart(2,'0')}</span><p>{t(x)}</p></div>)}</div></section>

      <section id="areas" className="slate"><div className="wrap section-head"><p className="kicker">04 · {lang==='it'?'AREE DI ATTIVITÀ':'AREAS OF ACTIVITY'}</p><h2>{lang==='it'?'Infrastrutture, sistemi, processi':'Infrastructure, systems, processes'}</h2></div><div className="wrap areas-grid">{areas.map((x,i)=><article key={i}><span>{String(i+1).padStart(2,'0')}</span><h3>{t(x)}</h3></article>)}</div></section>

      <section id="results" className="light"><div className="wrap section-head"><p className="kicker">05 · {lang==='it'?'RISULTATI CHIAVE':'KEY RESULTS'}</p><h2>{lang==='it'?'Numeri che descrivono la scala delle responsabilità':'Numbers that describe the scale of responsibility'}</h2></div><div className="wrap results-grid">{results.map((x,i)=><article key={i}><span>{String(i+1).padStart(2,'0')}</span><p>{t(x)}</p></article>)}</div></section>

      <section id="bridge" className="bridge dark"><div className="wrap bridge-grid"><div><p className="kicker">06 · PONTE SULLO STRETTO</p><h2>{lang==='it'?'Collegamenti ferroviari del Ponte sullo Stretto':'Railway connections to the Strait of Messina Bridge'}</h2></div><div><img className="bridge-image" src="./images/stretto.webp" alt=""/><p className="lead">{lang==='it'?'Dal novembre 2023 Giorgio Micolitti è Responsabile Ingegneria Collegamenti Ferroviari di Stretto di Messina S.p.A. e guida la relativa Struttura Organizzativa.':'Since November 2023, Giorgio Micolitti has served as Head of Railway Connections Engineering at Stretto di Messina S.p.A., leading the related organisational unit.'}</p></div></div></section>

      <section id="diary" className="light"><div className="wrap section-head"><p className="kicker">07 · PROJECT DIARY</p><h2>{lang==='it'?'Opere e cantieri in sequenza editoriale':'Works and construction sites in an editorial sequence'}</h2></div><div className="wrap diary">{diary.map((d,i)=><article className={i%2?'diary-row reverse':'diary-row'} key={d.image}><div className="diary-copy"><span>{String(i+1).padStart(2,'0')}</span><h3>{t(d.title)}</h3><p>{t(d.text)}</p></div><figure><img src={`./images/${d.image}`} alt={t(d.title)} loading="lazy"/><figcaption>{d.title.it}<em>{d.title.en}</em></figcaption></figure></article>)}</div></section>

      <section id="august-2022" className="editorial slate"><div className="wrap editorial-grid"><div><p className="kicker">08 · AGOSTO 2022</p><h2>{lang==='it'?'Il suono di due treni su un’opera appena realizzata':'The sound of two trains on a newly completed civil work'}</h2></div><div><p className="lead">{lang==='it'?'Uno dei lavori estivi eseguiti dalla squadra di Ingegneria Civile della DOIT Roma, in finestre operative complesse e programmate nei mesi di minore traffico.':'One of the summer works delivered by the DOIT Rome Civil Engineering team within complex possessions planned during lower-traffic periods.'}</p><a className="video-link" href="https://www.youtube.com/watch?v=B2XEBK2oEao" target="_blank" rel="noreferrer">{lang==='it'?'Guarda il video':'Watch the video'} ↗</a></div></div></section>

      <section id="teaching" className="light"><div className="wrap teaching-grid"><div><p className="kicker">09 · {lang==='it'?'DOCENZA':'TEACHING'}</p><h2>Sapienza<br/>Università di Roma</h2></div><div><p className="lead">{lang==='it'?'Docente di Tecnica dei Cantieri Infrastrutturali presso il Master Sapienza in Ingegneria delle Infrastrutture e dei Sistemi Ferroviari (IIS), edizioni 2020, 2021 e 2022.':'Lecturer in Infrastructure Construction Site Techniques within Sapienza University’s Master in Infrastructure and Railway Systems Engineering (IIS), editions 2020, 2021 and 2022.'}</p></div></div></section>

      <section id="publications" className="publications ivory"><div className="wrap section-head"><p className="kicker">10 · {lang==='it'?'PUBBLICAZIONI SELEZIONATE':'SELECTED PUBLICATIONS'}</p><h2>{lang==='it'?'Ricerca, sicurezza, normativa e geotecnica':'Research, safety, regulation and geotechnics'}</h2></div>{['01','02','03'].map(group=><div id={`pub-${group}`} className="wrap pub-group" key={group}><div className="pub-group-title">{group}</div><div>{publications.filter(p=>p[0]===group).map((p,i)=><article className="pub-item" key={i}><span>{p[1]}</span><div><h3>{p[2]}</h3><p>{p[3]}</p></div></article>)}</div></div>)}<div className="wrap awards"><h3>{lang==='it'?'Premi e riconoscimenti':'Awards and recognition'}</h3><div><strong>2001</strong><span>1° Premio Nazionale Società Italiana Gallerie</span></div><div><strong>2005</strong><span>1° Premio Nazionale CIFI — Collegio Ingegneri Ferroviari Italiani</span></div><div><strong>2008</strong><span>2° Premio Nazionale CIFI</span></div><div><strong>2011</strong><span>2° Premio Nazionale CIFI</span></div></div></section>
